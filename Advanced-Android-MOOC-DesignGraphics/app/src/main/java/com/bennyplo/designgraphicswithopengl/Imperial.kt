...
class Imperial {
    ...
    companion object {
        ...
        private val CharData = arrayOf(
            Triple(CharacterI.CharVertex.copyOf(), CharacterI.CharColor.copyOf(), CharacterI.CharIndex.copyOf()),
            Triple(CharacterM.CharVertex.copyOf(), CharacterM.CharColor.copyOf(), CharacterM.CharIndex.copyOf()),
            Triple(CharacterP.CharVertex.copyOf(), CharacterP.CharColor.copyOf(), CharacterP.CharIndex.copyOf()),
            Triple(CharacterE.CharVertex.copyOf(), CharacterE.CharColor.copyOf(), CharacterE.CharIndex.copyOf()),
            Triple(CharacterR.CharVertex.copyOf(), CharacterR.CharColor.copyOf(), CharacterR.CharIndex.copyOf()),
            Triple(CharacterI.CharVertex.copyOf(), CharacterI.CharColor.copyOf(), CharacterI.CharIndex.copyOf()),
            Triple(CharacterA.CharVertex.copyOf(), CharacterA.CharColor.copyOf(), CharacterA.CharIndex.copyOf()),
